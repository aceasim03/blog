...
[embedyt] https://www.youtube.com/watch?v=-BhkSF2hr74[/embedyt]

[embeddoc url="https://sites.duke.edu/aasim/files/2025/02/A.-Asim-The-Silk-Threads-Method-WOC-106-Final-Project-Proposal.pdf" viewer="browser"]
...
My topic was the student-tourist dilemma: should I do my work or travel? My problem was that we always saw it as an “or” thing when it can be an “and” thing. My video was to show students my method, The Silk Threads Method, of exploring different “threads” of Suzhou while doing homework. The way to do that is to find a “thread” you want to explore based on your workload, whether that be a famous garden, museum, or a more modern area. Tasks like reading, reflecting, and journaling happen better in gardens (for example, 网师园). Planning and tedious tasks are better done in the museum (my particular example was of the café at Suzhou Museum West) or somewhere around there. If you need to hunker down and do more deep work, go to the more modern Suzhou Industrial Park (SIP) to lock in.
...
I’ve learned a lot, and I want to say thank you to my Professor and her hard work. I also want to thank my classmates for helping me and coming on this journey with me. Thank you guys, this course will be missed.
